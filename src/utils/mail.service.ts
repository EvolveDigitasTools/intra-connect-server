...
export const sendMailSetup = async (type: string, sendTo: string | null = null, variables: { [key: string]: string | number } = {}) => {
    const mailOptions: MailOptions = {
        ...
        actionRoute: getMessage(mailDetails[type].actionRoute, variables),
...
const getMessage = (message: string | undefined, variables: { [key: string]: string | number }): string | undefined => {
    if (!message)
        return message;
    if (variables) {
