...
import { getTickets, newTicket, getTicket, newChat, getChats, closeTicket } from "../controllers/ticket.controller";
...
router.post('/:ticketId/close', validateAuthCode, closeTicket)
