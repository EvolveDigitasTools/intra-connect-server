...
const Ticket_1 = __importDefault(require("../tickets/Ticket"));
const TicketChat_1 = __importDefault(require("../tickets/TicketChat"));
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => TicketChat_1.default),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.INTEGER
    })
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => TicketChat_1.default)
