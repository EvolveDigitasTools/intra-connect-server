...
const WorkflowEdge_1 = __importDefault(require("./WorkflowEdge"));
const WorkflowDepartment_1 = __importDefault(require("./WorkflowDepartment"));
...
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => Department_1.default, () => WorkflowDepartment_1.default)
], Workflow.prototype, "departments", void 0);
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => WorkflowStep_1.default)
], Workflow.prototype, "steps", void 0);
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => WorkflowEdge_1.default)
